...
%define kernel_ver	4.18.0-193.1.2.el8_2
...
Source100: block-block-bfq-fix-use-after-free-in-bfq_idle_slice.patch
#
# https://bugzilla.redhat.com/1847371
Source101: x86-speculation-Prevent-rogue-cross-process-SSBD-shu.patch
#
# https://bugzilla.redhat.com/1847404
# https://bugzilla.redhat.com/1847402
Source102: kpatch-adapted-patch-for-CVE-2020-10767-and-CVE-2020-10768.patch
#
# https://bugzilla.redhat.com/1881426
Source103: net-packet-make-tp_drops-atomic.patch
#
# https://bugzilla.redhat.com/1881416
Source104: fs-xfs-fix-boundary-test-in-xfs_attr_shortform_verify.patch
...
* Thu Jun 25 2020 Julien Thierry <jthierry@redhat.com> [1-2.el8]
- Prevent rogue cross-process SSBD shutdown [1847371] {CVE-2020-10766}

* Mon May 25 2020 Artem Savkov <asavkov@redhat.com> [1-1.el8]
- use-after-free in block/bfq-iosched.c related to bfq_idle_slice_timer_body [1835531] {CVE-2020-12657}

* Mon May 11 2020 Artem Savkov <asavkov@redhat.com> [0-0.el8]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-193.1.2.el8_2 [1834315]
